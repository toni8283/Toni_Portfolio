  ...
  projects: [
    {
      ...
      tech: ["TypeScript", "React", "OMDb API", "Google Gemini API"],
    ...
    },
    {
      ...
      tech: ["TypeScript", "React", "Tailwind CSS", "Zustand", "Vercel"],
    ...
    },
    {
      ...
      description: "A dark-themed fitness tracking app designed for motivation and clarity giving users everything they need to plan, track, and review their workouts in one place.",
      newdescription: "The design spans four core screens: a Welcome/Login screen with social auth options, a personalized Home dashboard greeting the user by name with today's workout plan and activity rings, a Stats screen with a weekly calendar, distance/hydration metrics, step/calorie/minute tracking rings, and a heart rate chart, and a clean Profile screen with account management options. The visual language uses a dark charcoal base, neon activity rings (green, magenta, cyan), and bold red CTAs creating an energetic aesthetic that feels modern and gym-ready.",
      tech: ["Figma", "Mobile UI Design", "Data Visualization", "Component Design"],
      github: "",
    ...
    },
    {
      ...
      description: "A comprehensive internal platform designed to unify employee workflows from task tracking and announcements to team celebrations and tool access all within a cohesive, professional interface.",
      newdescription: "The design covers multiple key modules: a Home dashboard with workspace summary cards, announcements feed, upcoming birthdays, and quick-access shortcuts; a Tools Hub aggregating internal tools like Timesheet, Expenses, Leave, IT Help Desk, Payslips, Documents, and Policies into a single grid; and a Celebrate section for recognizing team wins, milestones, and birthdays. The UI follows a navy/white color palette with clear typographic hierarchy, consistent card components, and a persistent sidebar navigation balancing information density with visual breathing room.",
      tech: ["Figma", "UX Research", "Enterprise UI", "Hi-Fi Prototyping"],
      github: "",
    ...
    },
    {
      ...
      description: " bold, bilingual ad poster designed to convert frustrated learners into structured DSA students using sharp copy, a clear before/after contrast, and a product mockup that does the selling itself.",
      newdescription: "The poster leads with a punchy Hindi headline targeting the pain point of aimless YouTube learning, then pivots to AlgoZenith's structured roadmap as the solution. A ' Without AZ vs With AZ ' comparison card reinforces the value proposition visually, while a browser mockup of the actual DSA roadmap UI (with progress bars and unlocking modules) makes the product tangible. The warm beige background, orange accent palette, and bold sans-serif typography give the design an energetic, startup-forward feel that's equally at home on Instagram or a landing page.",
      tech: ["Figma", "Brand Design", "Marketing Design", "Visual Design"],
      github: "",
